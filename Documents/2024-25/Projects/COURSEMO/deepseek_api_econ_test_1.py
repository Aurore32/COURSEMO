...
response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": """
            You are an A-Level economics teacher. You will be given an A-Level data response question (an excerpt, followed by a question on the excerpt), as well as the marking scheme of the question which gives you guidance on how to answer it.
