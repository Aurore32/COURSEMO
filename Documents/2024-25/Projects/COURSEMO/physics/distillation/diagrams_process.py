...
dataset = pd.read_csv('physics/distillation/al_physics_diagrams_deepseek_r1.csv')
...
print(new_dataset)
new_dataset.to_csv('./physics/distillation/al_physics_diagrams_deepseek_r1_clean.csv')